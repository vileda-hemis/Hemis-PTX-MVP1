...
## Symptom: peers report `Hemis Core:1.3.1` but I installed v0.4.2-testnet
...
P2P subversion string. It is not the PTX release number. A node built from `v0.4.2-testnet`
advertises the lineage version to peers while `Hemisd -version` reports `v0.4.2-testnet`.
