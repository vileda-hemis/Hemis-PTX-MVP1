...
<!-- CORPUS-SHA256: 1971c73e7048fa9c22ef3ead37fddeaf77e35b16a839a7dd7f35b05e23bb694c -->

> **This document is a verbatim copy of `GM_QUICKSTART.md` at `v0.5.1-testnet`.** It is not
...
```bash
wget https://raw.githubusercontent.com/vileda-hemis/Hemis-PTX-MVP1/v0.5.1-testnet/vps-install.sh
bash vps-install.sh
```
