...
**Status:** Design recorded. NOT implemented — bound to W2.3 (first consumer) / W2.4. Cross-ref KDD-063 (shares the undo primitive), KDD-069 (single write edge), KDD-067 (superseded), ODC-034/037 (restore owes wipe + banlist-clear), ODC-035 (persistence subsumed; liveness → KDD-071), KDD-040/045 (the ≤2 bound is KDD-040's, relaxed by W2.5).
