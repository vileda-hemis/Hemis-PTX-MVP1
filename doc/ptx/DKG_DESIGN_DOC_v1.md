...
| KDD-052 | PTXDKG member set — committed node_id list, chain-determined (score) order; resolves OPEN-2. Selection/ordering contract concretized by KDD-060 (§20); score-order principle unchanged. INDEX-SPACE SEAM CLOSED LIVE 2026-07-23 (SG-3 signing gate): a threshold sig over NON-CONTIGUOUS score-order x's {2,3,4,5,6,7,9,10,11} verified against the committed group_pk — the retired alphabetical dealer mapping could not produce it. | §12 | Decided 2026-06-03; index-space closed-live 2026-07-23 |
