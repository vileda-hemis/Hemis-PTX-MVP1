#!/usr/bin/env python3
"""
Hemis PTX Phase 2 — Live Node Test Suite v6.1
==============================================
178 tests across 14 categories.
...
Usage (from node1 host — node has python3):
  python3 ptx_test_suite_v6.1.py --fast --skip-excl-probe --skip-lottery
  python3 ptx_test_suite_v6.1.py --skip-excl-probe --skip-lottery
  python3 ptx_test_suite_v6.1.py
...
def main():
    ...
    print("═"*68)
    print(f"  HEMIS PTX PHASE 2 — LIVE NODE TEST SUITE v6.1  (178 tests)")
    print(f"  RPC:  {RPC_URL}")
